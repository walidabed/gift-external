...
class CircleDropdownComp extends StatefulWidget {
  ...
  @override
  _CircleDropdownCompState createState() => _CircleDropdownCompState();
}

class _CircleDropdownCompState extends State<CircleDropdownComp> {
